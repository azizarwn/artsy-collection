...
const Productlist = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    // console.log("page", calculatedPage);
  }, [page]);

  // const pagination = (getPage) => {
  //   let res =  getAllPokemon(pokemonUrl(getPage))
                        ...
                        return (
                          <div key={index} className="paginNum-btn">
                            <Link
                              ...
                              className={page === item ? "pagin-btnNum pagin-btnNumActive" : "pagin-btnNum"}
                            >
                              {item}
                            </Link>
                          </div>
